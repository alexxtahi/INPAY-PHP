                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                                ...
                                <a href="#" class="primary-btn">Shop now
        ...
        <div class="container">
            ...
            <div class="row product__filter">
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg"
                            ...
                            <ul class="product__hover">
                                <li><a href="#"><img src="{{ asset('template/img/icon/heart.png') }}" alt=""></a>
                                </li>
                                <li><a href="#"><img src="{{ asset('template/img/icon/compare.png') }}" alt="">
                                        <span>Compare</span></a></li>
                                <li><a href="#"><img src="{{ asset('template/img/icon/search.png') }}" alt=""></a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg"
                            data-setbg="{{ asset('template/img/product/product-2.jpg') }}">
                            <ul class="product__hover">
                                <li><a href="#"><img src="{{ asset('template/img/icon/heart.png') }}" alt=""></a>
                                </li>
                                <li><a href="#"><img src="{{ asset('template/img/icon/compare.png') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix
                    ...
                    <div class="product__item sale">
                        <div class="product__item__pic set-bg"
                            data-setbg="{{ asset('template/img/product/product-3.jpg') }}">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg"
                            data-setbg="{{ asset('template/img/product/product-4.jpg') }}">
                            <ul class="product__hover">
                                <li><a href="#"><img src="{{ asset('template/img/icon/heart.png') }}" alt=""></a>
                                </li>
                                <li><a href="#"><img src="{{ asset('template/img/icon/compare.png') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg"
                            data-setbg="{{ asset('template/img/product/product-5.jpg') }}">
                            <ul class="product__hover">
                                <li><a href="#"><img src="{{ asset('template/img/icon/heart.png') }}" alt=""></a>
                                </li>
                                <li><a href="#"><img src="{{ asset('template/img/icon/compare.png') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix
                    ...
                    <div class="product__item sale">
                        <div class="product__item__pic set-bg"
                            data-setbg="{{ asset('template/img/product/product-6.jpg') }}">
                            <span class="label">Sale</span>
                            <ul class="product__hover">
                                <li><a href="#"><img src="{{ asset('template/img/icon/heart.png') }}" alt=""></a>
                                </li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg"
                            data-setbg="{{ asset('template/img/product/product-7.jpg') }}">
                            <ul class="product__hover">
                                <li><a href="#"><img src="{{ asset('template/img/icon/heart.png') }}" alt=""></a>
                                </li>
                                <li><a href="#"><img src="{{ asset('template/img/icon/compare.png') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg"
                            data-setbg="{{ asset('template/img/product/product-8.jpg') }}">
                            <ul class="product__hover">
                                <li><a href="#"><img src="{{ asset('template/img/icon/heart.png') }}" alt=""></a>
                                </li>
                                <li><a href="#"><img src="{{ asset('template/img/icon/compare.png') }}" alt="">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="categories__text">
                        <h2>Clothings Hot <br /> <span>Shoe Collection</span>
                            <br /> Accessories
                        </h2>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    <div class="instagram__pic">
                        <div class="instagram__pic__item set-bg"
                            data-setbg="{{ asset('template/img/instagram/instagram-1.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg"
                            data-setbg="{{ asset('template/img/instagram/instagram-2.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg"
                            data-setbg="{{ asset('template/img/instagram/instagram-3.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg"
                            data-setbg="{{ asset('template/img/instagram/instagram-4.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg"
                            data-setbg="{{ asset('template/img/instagram/instagram-5.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg"
                            data-setbg="{{ asset('template/img/instagram/instagram-6.jpg') }}"></div>
                    </div>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg"
                            data-setbg="{{ asset('template/img/blog/blog-1.jpg') }}"></div>
                        <div class="blog__item__text">
                            <span><img src="{{ asset('template/img/icon/calendar.png') }}" alt="">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <a href="#"><img src="{{ asset('template/img/payment.png') }}" alt=""></a>
                    </div>
                </div>
