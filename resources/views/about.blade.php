...
<ul><li>École supérieure d'agronomie (ENSA et IAB)</li>
...
<li>École doctorale polytechnique (EDP)</li></ul>
   ...
   <p>L'Institut compte huit grandes écoles, une classe préparatoire aux grandes écoles (CPGE), 
     ...
     <p>Il a treize amphithéâtres de 100 à 1500 places, trois bibliothèques, deux restaurants universitaires, 
       deux résidences universitaires avec 3008 chambres individuelles, trois centres de santé et deux gymnases.</p>
...
<ul><li>Ecole supérieure des travaux publics</li>
...
<li>Centre régional de formation supérieure en métrologie</li></ul>
...
<p>Les bâtiments du Site Centre ont à l’origine été ceux de l’Institut National Supérieur de l’Enseignement Technique (INSET).</p>
...
<p>Les bâtiments du Site Centre ont à l’origine été ceux de l’Ecole Nationale Supérieure d’Agronomie (ENSA) et de l’Institut Agricole de Bouaké (IAB)</p>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team__item">
                        <img src="{{ asset('template/img/about/Abdel.png')}}" alt="">
                        <h4>KONE Abdel</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team__item">
                        <img src="{{ asset('template/img/about/alex.jpg')}}"  alt="">
                        <h4>TAHI Alexandre</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team__item">
                        <img src="{{ asset('template/img/about/chantal.jpg')}}" alt="">
                        <h4>TAMO Chantal</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team__item">
                        <img src="{{ asset('template/img/about/olivier.jpg')}}" alt="">
                        <h4>TANOH Olivier</h4>
                    </div>
                </div>
            </div>
